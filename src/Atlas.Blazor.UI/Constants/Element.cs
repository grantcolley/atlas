namespace Atlas.Blazor.UI.Constants
{
    public static class Element
    {
        ...
        public const string Integer = "Atlas.Blazor.UI.Components.Mud.Integer`1, Atlas.Blazor.UI";
        public const string Label = "Atlas.Blazor.UI.Components.Mud.Label`1, Atlas.Blazor.UI";
        public const string Text = "Atlas.Blazor.UI.Components.Mud.Text`1, Atlas.Blazor.UI";
    }
}
